...
with st.expander("Machine Learning"):
    ...
    with col2:
        ...
        st.header(f"**🥈 Runner Up**: {runner_up}")
...
with st.expander("Live Predictions"):
    ...
    with col2:
        st.markdown(f"<p style='text-align: left; margin-top: 5px; margin-bottom: 0px; font-size: 84px; font-weight: bold;'>📡</p>", unsafe_allow_html=True)
